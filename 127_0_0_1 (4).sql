...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2015 at 12:21 PM
...
(37, 1, 'ID-VEISHVAM', 5, '2015-04-25 06:16:37', '0000-00-00 00:00:00'),
(38, 2, 'ID-VEISHVAM', 5, '2015-04-25 06:16:37', '0000-00-00 00:00:00'),
(39, 3, 'ID-VEISHVAM', 5, '2015-04-25 06:16:37', '0000-00-00 00:00:00');
...
(12, 1, 81, '2015-02-20 20:34:27', '0000-00-00 00:00:00'),
(13, 1, 82, '2015-02-20 20:34:27', '0000-00-00 00:00:00'),
(14, 2, 80, '2015-02-21 11:46:55', '0000-00-00 00:00:00'),
(15, 2, 81, '2015-02-21 11:46:55', '0000-00-00 00:00:00'),
(16, 2, 82, '2015-02-21 11:46:55', '0000-00-00 00:00:00');
...
(54, 81, 'ID-VEISHVAM', '1', 1),
(55, 82, 'ID-VEISHVAM', '1', 1),
(56, 80, 'ID-VEISHVAM', '2', 2),
(57, 81, 'ID-VEISHVAM', '2', 2),
(58, 82, 'ID-VEISHVAM', '2', 2);
...
INSERT INTO `messages` (`id`, `reservation_id`, `image`, `created_at`, `updated_at`, `deleted_at`) VALUES
(8, 'ID-VEISHVAM', 'ID-VEISHVAM.jpg', '2015-04-25 13:17:31', '2015-04-25 13:17:31', NULL);
...
('ID-VEISHVAM', 'Renz', '50', 'Calangi', '074 Malugay st. UPS1 SMDP Paranaque City', '09291806225', 'Black and Yellow', 'San Martin de Porres', 'Wedding', '2015-04-25', 100, 'Event End', '01:00', '01:00', '2015-05-09', '2015-05-10', 165623, 'Down Payment', 'Bank', '2015-04-25 13:15:13', '2015-05-10 17:02:14', NULL);
...
--
ALTER TABLE `agents`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `agents_employee_number_unique` (`employee_number`);
...
ALTER TABLE `collections`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `collections_cr_id_unique` (`cr_id`), ADD KEY `collections_quotation_id_foreign` (`quotation_id`);
...
ALTER TABLE `deliveries`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `deliveries_reference_number_unique` (`reference_number`), ADD KEY `deliveries_quotation_id_foreign` (`quotation_id`);

--
-- Indexes for table `delivery_item`
--
ALTER TABLE `delivery_item`
 ADD PRIMARY KEY (`id`), ADD KEY `delivery_item_delivery_id_foreign` (`delivery_id`), ADD KEY `delivery_item_item_id_foreign` (`item_id`);

--
-- Indexes for table `item_purchase`
--
ALTER TABLE `item_purchase`
 ADD PRIMARY KEY (`id`), ADD KEY `item_purchase_purchase_id_foreign` (`purchase_id`), ADD KEY `item_purchase_item_id_foreign` (`item_id`);

--
-- Indexes for table `item_quotation`
--
ALTER TABLE `item_quotation`
 ADD PRIMARY KEY (`id`), ADD KEY `item_quotation_quotation_id_foreign` (`quotation_id`), ADD KEY `item_quotation_item_id_foreign` (`item_id`);

--
-- Indexes for table `item_receiving`
--
ALTER TABLE `item_receiving`
 ADD PRIMARY KEY (`id`), ADD KEY `item_receiving_receiving_id_foreign` (`receiving_id`), ADD KEY `item_receiving_item_id_foreign` (`item_id`);

--
-- Indexes for table `item_reservation`
--
ALTER TABLE `item_reservation`
 ADD PRIMARY KEY (`id`);
...
ALTER TABLE `item_warehouse`
 ADD PRIMARY KEY (`id`), ADD KEY `item_warehouse_warehouse_id_foreign` (`warehouse_id`), ADD KEY `item_warehouse_item_id_foreign` (`item_id`);

--
-- Indexes for table `items`
--
ALTER TABLE `items`
 ADD PRIMARY KEY (`id`), ADD KEY `items_itemtype_id_foreign` (`itemtype_id`);
...
ALTER TABLE `menu_reservation`
 ADD PRIMARY KEY (`id`), ADD KEY `menu_reservation_menu_id_foreign` (`menu_id`), ADD KEY `menu_reservation_reservation_id_foreign` (`reservation_id`);

--
-- Indexes for table `messages`
--
ALTER TABLE `messages`
 ADD PRIMARY KEY (`id`), ADD KEY `messages_reservation_id_foreign` (`reservation_id`);
...
ALTER TABLE `payments`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `payments_payment_receipt_unique` (`payment_receipt`), ADD KEY `payments_purchase_id_foreign` (`purchase_id`);

--
-- Indexes for table `purchases`
--
ALTER TABLE `purchases`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `purchases_po_number_unique` (`po_number`), ADD KEY `purchases_supplier_id_foreign` (`supplier_id`);

--
-- Indexes for table `quotations`
--
ALTER TABLE `quotations`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `quotations_quotation_number_unique` (`quotation_number`), ADD KEY `quotations_client_id_foreign` (`client_id`), ADD KEY `quotations_agent_id_foreign` (`agent_id`);

--
-- Indexes for table `receivings`
--
ALTER TABLE `receivings`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `receivings_reference_number_unique` (`reference_number`), ADD KEY `receivings_purchase_id_foreign` (`purchase_id`);
...
--
-- AUTO_INCREMENT for table `item_quotation`
--
ALTER TABLE `item_quotation`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `item_reservation`
--
ALTER TABLE `item_reservation`
...
--
-- AUTO_INCREMENT for table `menu_reservation`
--
ALTER TABLE `menu_reservation`
