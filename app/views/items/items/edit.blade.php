...
@section ('body')
  <a href="{{ action('Items\ItemsController@show', ['item' => $item->id]) }}"><i class="fa fa-arrow-left"></i> Back to Items</a>
  <h1 class="page-header"><i class="fa fa-user"></i> Edit Item</h1>
  {{ Form::model($item, ['method' => 'put', 'action' => ['Items\ItemsController@update', $item->id], 'role' => 'form','files' => true]) }}
    <div class="row">
