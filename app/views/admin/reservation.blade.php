...
@section('body')
    {{ Form::open(['action' => 'AdminController@storeRes', 'role' => 'form']) }}
...
<div class='row'>
                                                {{--LALALAL--}}
                                                 <div class="checkbox">
                                                     ...
                                                     <div class="col-lg-6">
                                                         <input type="checkbox" required name="condition" value="checkbox" style="width: 13px;" /> I agree the <a rel="facebox" data-toggle="modal" data-target="#myModal" href="#">terms and condition</a> of this site
                                                                                                                                                                                                 </div>
                                                 </div>
</div>
<div class='row'>
                                                 <div class="form-group">
                                                     <div class="col-lg-12 ">
                                                         ...
                                                         <button type="submit" class="form-control btn btn-primary" value="Reserve"> Submit</button>
                                                     </div>
                                                 </div>
                                                 </div>
