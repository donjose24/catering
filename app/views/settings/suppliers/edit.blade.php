...
@section('title')
  <a href="{{ action('Settings\SuppliersController@show', ['client' => $suppliers->id]) }}"><i class="fa fa-arrow-left"></i> Back to Suppliers</a>
  <h1 class="page-header"><i class="fa fa-user"></i> Edit Client</h1>
@stop

@section ('body')

  {{ Form::model($suppliers, ['method' => 'put', 'action' => ['Settings\SuppliersController@update', $suppliers->id], 'role' => 'form']) }}
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="basic">
        ...
        <div class="form-group {{ $errors->has('customer_name') ? 'has-error' : ''}}">
          {{ Form::label('supplier_name', 'Customer Name', array('class' => 'control-label')) }}
