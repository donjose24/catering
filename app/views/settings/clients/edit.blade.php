...
@section('title')
  <a href="{{ action('Settings\ClientsController@show', ['client' => $client->id]) }}"><i class="fa fa-arrow-left"></i> Back to Clients</a>
  <h1 class="page-header"><i class="fa fa-user"></i> Edit Client</h1>
@stop
@section ('body')

  {{ Form::model($client, ['method' => 'put', 'action' => ['Settings\ClientsController@update', $client->id], 'role' => 'form']) }}
